...
{
	public class MalachiteBeam : ModProjectile
    {
            ...
            if (projectile.frameCounter >= 5)
			{
                ...
                if (num2 != -1)
                {
                    ...
                    if (flag)
                    {
                        ...
                        value *= num5;
                        int p = Terraria.Projectile.NewProjectile(target.Center.X, target.Center.Y, value.X, value.Y, mod.ProjectileType("MalachiteBeam1"), 100, 0f, projectile.owner, 0f, 0f);
